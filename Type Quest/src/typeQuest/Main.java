...
public class Main {
	...
	public static void main(String[] args) {
		p.level = 1;
		p.health = (int) (Math.random() * (1.5 * 5) + 5);
	...
	public static void storyBegins() {
		...
		if (choice.equalsIgnoreCase("proceed")) {
			...
			if (choice.equalsIgnoreCase("shadow cavern")) {
				...
				neMe.money = true;
				neMe.level = 1;
				neMe.health = (int) (Math.random() * (1.5 * neMe.level) + 4);
				neMe.damage = 2;
				commenceBattle();
			}
		} else {
	...
	public static void commenceBattle() {
		...
		do {
			...
			System.out.println("You have encountered a " + neMe.type + " >> "
			...
			System.out.println("\n" + p + " HP:" + getPlayerHealthBar() + "\n"
					+ neMe + " HP:" + getEnemyHealthBar() + "\n");
	...
	/*
	 * static void endGame() { if (p.health < 1) { System.out.println(
	 ...
	 * "\n\n\n-Would you like to play again? (\"yes\" or \"no\")-"); choice =
	 * Keyboard.keyb.nextLine(); } while (!choice.equalsIgnoreCase("yes") &&
	 * !choice.equalsIgnoreCase("no")); if (choice.equalsIgnoreCase("yes"))
	 * mainMenu(); } else {
	 * System.out.println("You have died... You let us down..."); do {
	 * System.out
	 * .println("\n\n\n-Would you like to play again? (\"yes\" or \"no\")-");
	 * choice = Keyboard.keyb.nextLine(); } while
	 * (!choice.equalsIgnoreCase("yes") && !choice.equalsIgnoreCase("no")); if
	 * (choice.equalsIgnoreCase("yes")) mainMenu(); } }
	 */
}
