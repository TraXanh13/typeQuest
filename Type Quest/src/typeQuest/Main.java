...
public class Main {
	...
	static void getInventory(){
		...
		if(temp == 1){
			item.add(new Item(1, "Potion"));
		}else if(temp == 2){
			item.add(new Item(1, "Super Potion"));
		}
	}
	...
	public static void storyBegins() {
		item.add(new Item(1, "Poison Antidote"));
		item.add(new Item(1, "Paralyze Antidote"));
		item.add(new Item(1, "Potion"));
		for (int i = 0; i <= 5; i++) {
		...
		if (choice.equalsIgnoreCase("investigate")) {
			...
			do {
				System.out
						.println("What do you want to do? (Check the \"bush\" or \"proceed\"?)");
				choice = Keyboard.keyb.nextLine();
		...
		if (choice.equalsIgnoreCase("investigate")) {
			do {
				...
				choice = Keyboard.keyb.nextLine();
					...
					&& !choice.equalsIgnoreCase("further"));
			...
			if (choice.equalsIgnoreCase("investigate"))
				System.out
						.println("You poke your head into the flowers. There is nothing in this area");
			System.out
					.println("You continue around the corner. The sun is starting to set now. The sky is painted with an array of pink, orange, and yellow. It is truly mesmerizing.");
		}
	}
	...
	static void headToShadowCavern() {
		...
		if (choice.equalsIgnoreCase("investigate")) {
			...
			System.out.println("You put your arm in a hole the wall"
	...
	public static void initialize() {
		...
		pages[7] = new Page(
				"You have decided to go down Starlight Path. The path looks really peaceful and quiet"
		...
		// Starlight Path
		rooms[15] = new Room(
				"The path is bordered by beautiful yellow flowers, nothings seems to be a problem"
						+ "\nI think I made the best choice, this is going to be a walk in the park.");
		rooms[16] = new Room(
				"You poke your head into the flowers and find a paralyze antidote"
						+ "\n\nYou have obtained:\n+1 Paralyze Antidote\n"
		...
		rooms[18] = new Room(
				"You go back to the main trial and continue on with the quest"
